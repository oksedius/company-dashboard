...
export const CompanyDashboard: React.FC = () => {
  const [selectedCompanies, setSelectedCompanies] = useState<Record<ViewId, string>>({
    widget1: 'com_NX6GzO', 
    widget2: 'com_agj00z',
    widget3: 'com_0XLDdX', 
  });
  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 shadow-lg z-10">
        ...
        <p className="text-blue-100">Drag windows to rearrange • Resize by dragging borders • Split windows with buttons</p>
      </div>
